 ...
 */
@WebServlet("/ApllicationServlet")
public class ApllicationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="insert into applicationtable values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...

			{
				...
				pst.setString(2,fname);
					...
					out.println("<a href='LoginHome.html'>ClickHere To GoBack</a>");
			}
			catch(Exception e)
			{
