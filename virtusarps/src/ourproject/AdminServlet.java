		...
		String password=request.getParameter("pwd");
				...
				ResultSet rs = stmt.executeQuery(sqlquery);)
			{
				while(rs.next())
				{
					...
					if((userid.equals(emplog))&&(password.equals(emppassword))&&(roleid==a))
			                 {  
						        out.println("welcome");
						        HttpSession session=request.getSession();
			    	            disp=request.getRequestDispatcher("AdminLogin.html");
				...
				disp=request.getRequestDispatcher("wrong.html");
